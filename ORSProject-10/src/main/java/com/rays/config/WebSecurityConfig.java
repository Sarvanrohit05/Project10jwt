...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	 ...
	 * Exception { // We don't need CSRF for this example // cors site request
	 * forgery httpSecurity.csrf().disable() // dont authenticate this particular
	 * request .authorizeRequests().antMatchers("/Auth/**",
	 * "/User/profilePic/**").permitAll() .antMatchers(HttpMethod.OPTIONS,
